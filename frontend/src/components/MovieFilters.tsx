...
import type { MovieFacets, MovieSortField } from '@/types/api'
import { SORT_OPTIONS, type MovieFilterState } from '@/utils/movieSort'
...
export function MovieFilters({
  ...
  return (
    <div className="flex flex-col gap-4 border border-ink p-4 sm:flex-row sm:flex-wrap sm:items-end sm:gap-x-6">
      <FilterSelect
        label="Genre"
        value={state.genre}
